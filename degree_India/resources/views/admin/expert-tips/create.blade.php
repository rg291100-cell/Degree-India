...
@section('title', 'Create Expert Tip')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Create New Expert Tip</h4>
                    ...
                    <form action="{{ route('admin.expert-tips.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('video_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Thumbnail will be auto-generated from this link</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @error('thumbnail')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">If not provided, will be auto-generated from video
                                        link</small>
                                </div>
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save"></i> Save Expert Tip
                            </button>
                        </div>
                    </form>
                </div>
